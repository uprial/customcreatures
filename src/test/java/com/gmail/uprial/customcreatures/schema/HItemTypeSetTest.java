...
public class HItemTypeSetTest {
    ...
    public void testAllEntityTypes() {
        ...
        List<EntityType> deadEntityTypes = Lists.newArrayList(
                ...
                LLAMA_SPIT, MANGROVE_BOAT, MANGROVE_CHEST_BOAT, MARKER,
                MINECART, OAK_BOAT, OAK_CHEST_BOAT, OMINOUS_ITEM_SPAWNER,
                PAINTING, PALE_OAK_BOAT, PALE_OAK_CHEST_BOAT, SHULKER_BULLET,
                SMALL_FIREBALL, SNOWBALL, SPAWNER_MINECART, SPLASH_POTION,
                SPRUCE_BOAT, SPRUCE_CHEST_BOAT, SPECTRAL_ARROW, TEXT_DISPLAY,
                TNT, TNT_MINECART, TRIDENT, UNKNOWN,
                WIND_CHARGE, WITHER_SKULL);
