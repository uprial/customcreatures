...
public class HItemTypeSetTest {
    ...
    public void testAllEntityTypes() throws Exception {
        ...
        List<EntityType> deadEntityTypes = Lists.newArrayList(
                AREA_EFFECT_CLOUD, ARMOR_STAND, ARROW, BLOCK_DISPLAY,
                BOAT, BREEZE_WIND_CHARGE, CHEST_BOAT, CHEST_MINECART,
                COMMAND_BLOCK_MINECART, DRAGON_FIREBALL, EGG, ENDER_PEARL,
                ...
                ITEM, ITEM_DISPLAY, ITEM_FRAME, LEASH_KNOT,
                LIGHTNING_BOLT, LLAMA_SPIT, MARKER, MINECART,
                OMINOUS_ITEM_SPAWNER, PAINTING, POTION, SHULKER_BULLET,
                SMALL_FIREBALL, SNOWBALL, SPAWNER_MINECART, SPECTRAL_ARROW,
    ...
    public void testView() throws Exception {
        ...
        assertEquals("ANIMALS: [ALLAY, ARMADILLO, AXOLOTL, BAT, BEE, CAMEL, CAT, CHICKEN, " +
                ...
                "MONSTERS: [BLAZE, BOGGED, BREEZE, CAVE_SPIDER, CREEPER, DROWNED, ELDER_GUARDIAN, ENDERMAN, " +
                "ENDERMITE, ENDER_DRAGON, EVOKER, EVOKER_FANGS, GHAST, GIANT, GUARDIAN, HOGLIN, " +
                "HUSK, ILLUSIONER, MAGMA_CUBE, PHANTOM, PIGLIN, PIGLIN_BRUTE, PILLAGER, RAVAGER, " +
                "SHULKER, SILVERFISH, SKELETON, SKELETON_HORSE, SLIME, SPIDER, STRAY, VEX, " +
