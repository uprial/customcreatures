...
public enum HItemTypeSet {
    ...
    MONSTERS(null,
            Sets.newHashSet(BLAZE, BOGGED, BREEZE, CAVE_SPIDER, CREEPER, DROWNED, ELDER_GUARDIAN, ENDER_DRAGON,
                    ENDERMAN, ENDERMITE, EVOKER, EVOKER_FANGS, GHAST, GIANT, GUARDIAN, HOGLIN,
